...
// https://www.instructables.com/ESP32-Bluetooth-Tutorial-How-to-Use-Inbuilt-Blueto/
...
// BluetoothSerial srv_ui_bt_Serial;
#define srv_ui_bt_Serial Serial1
#else
...
{
#ifdef ESP32
    // srv_ui_bt_Serial.begin("srv_ui_bt_Serial")); //Bluetooth device name    
    srv_ui_bt_Serial.begin(9600);
#else
    srv_ui_bt_Serial.begin(115200);
#endif
